...
>  `listName.Add(string)`
> 1. `Designer: ` - Add a label, textbox ( For the user to enter a student name ) and a button ( Content = "Add Student ). Add a click event to the button. 
...
>  `listName[index]`
> 1. `Designer: ` - Add a label, textbox ( to take an index ), and a button ( Content = "Display Student Name" ). Add a click event.
...
> 1. `Designer: ` - Add another button ( Content = "Remove by index" ) and a click event. You will use the same Text Box from Part 3 to get the index.
> 2. `Code:` - In your click event, take the number from your textbox, parse it into an int	
> ( ***Indexs are ALWAYS whole numbers*** ). 
...
> 1. `Designer: ` - Add another button ( Content = "Add Student At Index" ) and add a click event. You will use your TextBoxes for Student Name and Index for this Part.
> 2. `Code:` - In your click event, take the number from your textbox, parse it into an int.
...
>  `listName.Clear()`
> 1. `Designer: ` - Add another button ( Content = "Clear list" ) and add a click event.
